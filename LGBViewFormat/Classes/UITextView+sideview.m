...
-(void)lgb_setLeftSideView:(UIView *)sideView padding:(CGFloat)padding
{
    ...
    NSLayoutConstraint *xConstrain = [NSLayoutConstraint constraintWithItem:sideView attribute:NSLayoutAttributeLeft relatedBy:NSLayoutRelationEqual toItem:self attribute:NSLayoutAttributeLeft multiplier:1.0 constant:0];
    
    NSLayoutConstraint *yConstrain = [NSLayoutConstraint constraintWithItem:sideView attribute:NSLayoutAttributeTop relatedBy:NSLayoutRelationEqual toItem:self attribute:NSLayoutAttributeTop multiplier:1.0 constant:0];
    ...
    self.textContainerInset = UIEdgeInsetsMake(0, CGRectGetWidth(sideView.bounds) + padding, 0, insets.right);
...
-(void)lgb_setRightSideView:(UIView *)sideView padding:(CGFloat)padding
{
    ...
    NSLayoutConstraint *xConstrain = [NSLayoutConstraint constraintWithItem:sideView attribute:NSLayoutAttributeRight relatedBy:NSLayoutRelationEqual toItem:self attribute:NSLayoutAttributeRight multiplier:1.0 constant:0];
